                                                    ...
                                                    <tbody><tr>
                                                        <td valign="middle" align="center" style="line-height: 1px;">
                                                            <div style="border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;display:inline-block; " cellspacing="0" cellpadding="0" border="0">
                                                                <div>                                                                  
                                                                        <img ng-if="col.img.source != 'url'" width="150" vspace="0" hspace="0" border="0" alt="La Oferta Irresistible" style="float: left;max-width:150px;" class="rnb-logo-img" src="">
                                                                </div>
                                                            </div></td>
                                                    </tr>
                                                </tbody></table>
                    ...
                    <td class="rnb-del-min-width" valign="top" align="center" style="min-width: 590px;">
                        <table width="100%" cellpadding="0" border="0" bgcolor="#f9fafc" align="center" cellspacing="0" style="background-color: rgb(249, 250, 252);">
                            <tbody><tr>
                             ...
                             <tr>
                              <a href="@yield('boton-llamada-accion-link')" style="text-decoration: none; ">
