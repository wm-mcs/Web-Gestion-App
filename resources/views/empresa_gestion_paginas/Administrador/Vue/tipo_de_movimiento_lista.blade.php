            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 formulario-label-fiel">
                  ...
                  <input v-model="data_editar.descripcion_breve" type="text" class="formulario-field"
                    placeholder="Algo que explique">
                </div>
                ...
                <div v-if="data_editar.movimiento_de_empresa_a_socio == 'si'" class="col-6 formulario-label-fiel">
                  ...
                  <div class="formulario-label-aclaracion">
                    Si fuera un cobro se da por entendido que se paga. Si es agregar un cargo se da por entendido que se
                    paga.
                  </div>
                ...
                <div v-if="data_editar.movimiento_de_empresa_a_socio == 'si'" class="col-6 formulario-label-fiel">
                  ...
                  <div class="formulario-label-aclaracion">
                    Es para cuando se ingresa un movimiento desde la cuenta del socio. ejemplo un cobro se da por
