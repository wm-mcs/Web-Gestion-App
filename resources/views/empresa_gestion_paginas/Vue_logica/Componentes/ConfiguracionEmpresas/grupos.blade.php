...
@section('content')
  ...
  <div class="row mx-0">
    <h1 class="col-12 col-lg-8 h3 font-weight-bold" >Grupos</h1>
    <div class="col-12 col-lg-4">
      <crear></crear>
    </div>
    <p class="col-12 my-5 text-center">
     <small>Usalos para unir socios que van avanzando juntos en los cursos.</small>
    </p>
...
<script type="text/javascript">
    ...
    @include('empresa_gestion_paginas.Vue_logica.Componentes.ConfiguracionEmpresas.Componentes.Grupo.crear')
    @include('empresa_gestion_paginas.Vue_logica.Componentes.ConfiguracionEmpresas.Componentes.Grupo.listado')
