Vue.component("agregar-al-socio-un-servicio", {
  ...
  template: `<span>
    ...
    <div class="modal fade" id="modal-agregar-servicio-socio" tabindex="+1" role="dialog"
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="formulario-label-fiel" v-if="es_clase">
                        ...
                        <input type="number" min="1" class="formulario-field"
                            v-model="servicio_data.cantidad_de_servicios" />
                    </div>

                    <div class="formulario-label-fiel" v-if="se_puede_mostrar">
                        <label class="formulario-label">Valor <span v-if="servicio_data.cantidad_de_servicios"> de todas
                                las clases</span> </label>
                    ...
                    <div class="formulario-label-fiel" v-if="se_puede_mostrar">
                        <label class="formulario-label">¿Lo paga ahora? <span class="formulario-label-aclaracion"> Puede
                                que quede debiendo</span></label>
                    ...
                    <div v-else v-on:click="crear_servicio_a_socio" class="boton-simple mt-4">
                        @{{ $root . boton_aceptar_texto }}</div>


                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                        data-dismiss="modal">@{{ $root . boton_cancelar_texto }}</button>
                </div>
            </div>
        </div>
    </div>
