...
class SucursalEmpresa extends Model
{
    ...
    protected $appends  = ['movimientos_de_caja','saldo_de_caja_pesos','saldo_de_caja_dolares','movimientos_de_caja_pesos','movimientos_de_caja_dolares','puede_ver_el_user'];
