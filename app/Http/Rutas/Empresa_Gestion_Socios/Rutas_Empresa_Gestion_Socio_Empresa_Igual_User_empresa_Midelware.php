...
Route::post('vincular_socio_con_grupo',
    [
        'uses' => 'Admin_Empresa\SocioControllers@vincular_socio_con_grupo',
        'as'   => 'vincular_socio_con_grupo']);

Route::post('desvincular_socio_con_grupo',
    [
        'uses' => 'Admin_Empresa\SocioControllers@desvincular_socio_con_grupo',
        'as'   => 'desvincular_socio_con_grupo']);

Route::post('get_grupos_del_socio',
    [
        'uses' => 'Admin_Empresa\SocioControllers@get_grupos_del_socio',
        'as'   => 'get_grupos_del_socio']);
