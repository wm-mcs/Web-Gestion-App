...
class AnaliticasController extends Controller
{
    ...
    public function get_movimientos_de_caja_para_analiticas(Request $Request)
    {
        ...
        return HelpersGenerales::formateResponseToVue(true, 'Datos cargados', ['Movimientos' => $Movimientos, 'Perido' => 'Del ' . $Fecha_inicio->format('d-m-y') . ' al ' . $Fecha_fin->format('d-m-y')]);
    }
